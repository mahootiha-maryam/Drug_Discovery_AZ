...
train_ds_pos = torch.load("positive_train_dataset_new.pt")
train_ds_neg = torch.load("negative_train_dataset_new.pt")
val_ds_pos = torch.load("positive_val_dataset_new.pt")
val_ds_neg = torch.load("negative_val_dataset_new.pt")
test_ds_pos = torch.load("positive_test_dataset_new.pt")
test_ds_neg = torch.load("negative_test_dataset_new.pt")
...
val_losses.to_csv("val_losses.csv")